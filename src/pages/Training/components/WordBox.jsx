...
let color
function WordBox({ word, setWordHard, removeWord }) {
    // console.log(word)
    word.userWord !== undefined && word.userWord.difficulty === "hard"
        ? color = "#FF0000"
        : color = "#272C36"
    const [btnColor, updateColor] = useState(color)
    const colorHandler = () => {
        setWordHard(word._id)
        updateColor("#FF0000")
    }
    return (
